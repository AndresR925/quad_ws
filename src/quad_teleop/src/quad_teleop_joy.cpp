//El nodo recibe señales de un joystick/gamepad y las convierte en comandos de movimiento y control para un robot cuadrúpedo. 
//Publica estos comandos en el tópico /hyperdog_joy_ctrl_cmd para que otros nodos los usen.
...
#include "quad_msgs/msg/JoyCommands.hpp"
// #include "hyperdog_msgs/msg/ctrl_variables.hpp"

#include "quad_definitions.hpp"
...
auto cmd = quad_msgs::msg::JoyCommands();
...
class PublishingSubscriber : public rclcpp::Node
{
  public:
    ...
    : Node("hyperdog_teleop_gamepad_node")
    {
      ...
      publisher_ = this->create_publisher<quad_msgs::msg::JoyCommands>("hyperdog_joy_ctrl_cmd",40);
    }
  ...
  private:
    ...
    rclcpp::Publisher<quad_msgs::msg::JoyCommands>::SharedPtr publisher_;
};
